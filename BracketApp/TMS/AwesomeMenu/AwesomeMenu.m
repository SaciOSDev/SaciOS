...
- (id)initWithFrame:(CGRect)frame menus:(NSArray *)aMenusArray
{
    ...
    if (self) {
        ...
        // add the "Add" Button.
        _addButton = [[AwesomeMenuItem alloc] initWithImage:[UIImage imageNamed:@"ShortMenu.png"]
                                           highlightedImage:[UIImage imageNamed:@"ShortMenu.png"] 
                                               ContentImage:[UIImage imageNamed:@"ShortMenu.png"] 
                                    highlightedContentImage:[UIImage imageNamed:@"ShortMenu.png"]];
